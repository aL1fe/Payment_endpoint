...
-- That table is created by the Alembic migration in migrations/versions/.
-- This script only sets up the tables owned by other parts of the system
-- (users, products, carts, cart_items, user_payment_methods) so the app
-- has something to run against locally, plus sample data for testing.
